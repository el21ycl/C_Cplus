...
int main()
{
	...
	while (test1 == 0) 	 	 	                                          /*a while loop to keep the program running until the user selects option 3*/
	{
		...
		case 2:
			system("cls");
			printf("please select what you are going to do:\n\t1. Check whether the customer exist\n\t2. Rent a DVD\n\t3. Return a DVD.\n\t4. Determine customer charges and penalties\n\t5. Return\n");
			while (scanf("%d", &choice3) != 1 || (choice3 < 1 || choice3>5))		/* Display menu and get user's choice and its validity*/
			{
				printf("Your choice is invalid\n");
				Sleep(2000);
				fflush(stdin);
